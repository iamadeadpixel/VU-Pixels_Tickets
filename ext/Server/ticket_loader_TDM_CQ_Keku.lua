...
local Keku_TDM_CQ_LevelNameMap = {
...
Events:Subscribe('Level:LoadResources', function(p_LevelName_Keku_TDM_CQ, p_GameMode_Keku_TDM_CQ, p_IsDedicatedServer)
-- Contains ALL GameModemap data
	local s_GameMode_Keku_TDM_CQ = ServerUtils and ServerUtils:GetCustomGameModeName() or global_GameModeNameMap[p_GameMode_Keku_TDM_CQ] or p_GameMode_Keku_TDM_CQ

-- Contains TDM map data
	s_LevelName_Keku_TDM_CQ = ServerUtils and ServerUtils:GetCustomMapName() or Keku_TDM_CQ_LevelNameMap[p_LevelName_Keku_TDM_CQ] or p_LevelName_Keku_TDM_CQ and s_GameMode_Keku_TDM_CQ == "TDM Close Quarters"

-- ------------------------------------------------------------------------------

	if (Keku_TDM_CQ_LevelNameMap[p_LevelName_Keku_TDM_CQ] ~= nill) then
	s_vehicles = "true"
	s_vehicles_status = "Enabled"
	s_MapData="Keku_TDM_CQ"
...
-- ------------------------------------------------------------------------------
	...
	if lm == p_LevelName_Keku_TDM_CQ  and s_GameMode_Keku_TDM_CQ == "TDM Close Quarters" then

	local s_MaxPlayersRCON = RCON:SendCommand('vars.maxPlayers')
	local s_MaxPlayers = tonumber(s_MaxPlayersRCON[2])
	
	print(''..s_MapData..': - Reading map data: '..s_LevelName_Keku_TDM_CQ..' - '..s_GameMode_Keku_TDM_CQ..' ')
