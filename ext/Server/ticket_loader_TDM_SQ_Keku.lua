...
local Keku_TDM_SQ_LevelNameMap = {
...
Events:Subscribe('Level:LoadResources', function(p_LevelName_Keku_TDM_SQ, p_GameMode_Keku_TDM_SQ, p_IsDedicatedServer)
-- Contains ALL GameModemap data
	local s_GameMode_Keku_TDM_SQ = ServerUtils and ServerUtils:GetCustomGameModeName() or global_GameModeNameMap[p_GameMode_Keku_TDM_SQ] or p_GameMode_Keku_TDM_SQ

-- Contains TDM map data
	s_LevelName_Keku_TDM_SQ = ServerUtils and ServerUtils:GetCustomMapName() or Keku_TDM_SQ_LevelNameMap[p_LevelName_Keku_TDM_SQ] or p_LevelName_Keku_TDM_SQ and s_GameMode_Keku_TDM_SQ == "Squad Deathmatch"

-- TDM_SQ Maps Vehicles disabled
	local d_LevelName = ServerUtils and ServerUtils:GetCustomMapName() or Keku_TDM_SQ_LevelNameMap[p_LevelName_Keku_TDM_SQ]

-- ------------------------------------------------------------------------------

	if (Keku_TDM_SQ_LevelNameMap[p_LevelName_Keku_TDM_SQ] ~= nill) then
	s_vehicles = "true"
	s_vehicles_status = "Enabled"
	s_MapData="Keku_TDM_SQ"
...
-- Experimental: Setting vehicles on or off on specific map, any other map should be enabled
	if d_LevelName == s_LevelName_Keku_TDM_SQ and global_GameModeNameMap[p_GameMode_Keku_TDM_SQ] == "Squad Deathmatch" then
		s_vehicles = "false"
...
-- ------------------------------------------------------------------------------
	...
	if lm == p_LevelName_Keku_TDM_SQ  and s_GameMode_Keku_TDM_SQ == "Squad Deathmatch" then

	local s_MaxPlayersRCON = RCON:SendCommand('vars.maxPlayers')
	local s_MaxPlayers = tonumber(s_MaxPlayersRCON[2])
	
	print(''..s_MapData..': - Reading map data: '..s_LevelName_Keku_TDM_SQ..' - '..s_GameMode_Keku_TDM_SQ..' ')
