...
-- Contains ALL GameModemap data
	local s_GameMode_GunMaster = ServerUtils and ServerUtils:GetCustomGameModeName() or GameMode_GunMaster[p_GameMode_GunMaster] or p_GameMode_GunMaster

-- Contains GunMaster map data
	s_LevelName_GunMaster = ServerUtils and ServerUtils:GetCustomMapName() or GunMaster[p_LevelName_GunMaster] or p_LevelName_GunMaster
...
-- ------------------------------------------------------------------------------
	...
	m_GameMode = s_GameMode_GunMaster
	m_LevelName = s_LevelName_GunMaster
		m_tickets = ""
		map_tickets = ""
		m_vehicles = ""
		m_vehicles_status = ""
